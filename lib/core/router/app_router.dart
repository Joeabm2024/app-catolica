  ...
  (ref) {
    ...
    return GoRouter(
      ...
      routes: [
        ...
        // Cantos: catálogo de solo lectura.
        GoRoute(
          path: '/cantos',
          parentNavigatorKey:
              _rootNavigatorKey,
          ...
          routes: [
            GoRoute(
              ...
              builder: (context, state) {
                ...
                if (cantoId == null ||
                    cantoId.trim().isEmpty) {
                  return const _RutaInvalidaScreen(
                    mensaje:
                        'No se proporcionó un identificador de canto.',
                  );
                }

                return CantoDetalleScreen(
                  cantoId: cantoId,
                );
              },
            ),
          ...
          routes: [
            ...
            GoRoute(
              ...
              builder: (context, state) {
                ...
                if (oracionId == null ||
                    oracionId.trim().isEmpty) {
                  return const _RutaInvalidaScreen(
                    mensaje:
                        'No se proporcionó un identificador de oración.',
                  );
                }

                return OracionDetalleScreen(
                  oracionId: oracionId,
                );
              },
            ),
...
class _RutaInvalidaScreen
    extends StatelessWidget {
  final String mensaje;

  const _RutaInvalidaScreen({
